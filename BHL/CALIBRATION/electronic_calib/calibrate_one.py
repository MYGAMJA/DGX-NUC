...
OUTPUT_DIR = os.path.join(BHL_DIR, "CALIBRATION", "electronic_calib")
LOG_MD = os.path.join(BHL_DIR, "docs", "motor_calibration_2026-05-15.md")
...
def main():
    ...
    try:
        ...
        before_path = os.path.join(OUTPUT_DIR, f"motor_id{dev}_before_cal.json")
        ...
        after_path = os.path.join(OUTPUT_DIR, f"motor_id{dev}_after_cal.json")
