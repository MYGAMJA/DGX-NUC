"""Train BHL biped with PhysX backend (no Newton override)."""
...
# cli_args.py is in BHL scripts/rsl_rl
...
parser = argparse.ArgumentParser(description="Train BHL biped with RSL-RL (PhysX).")
parser.add_argument("--video", action="store_true", default=False, help="Record videos during training.")
parser.add_argument("--video_length", type=int, default=200, help="Length of the recorded video (in steps).")
parser.add_argument("--video_interval", type=int, default=2000, help="Interval between video recordings (in steps).")
parser.add_argument("--num_envs", type=int, default=None, help="Number of environments to simulate.")
parser.add_argument("--task", type=str, default="Velocity-Berkeley-Humanoid-Lite-Biped-v0", help="Task name.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # Keep Isaac Lab defaults => PhysX backend.
